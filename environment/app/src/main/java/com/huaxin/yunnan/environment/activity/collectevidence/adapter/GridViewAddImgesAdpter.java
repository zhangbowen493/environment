...
public class GridViewAddImgesAdpter extends BaseAdapter {
    ...
    public GridViewAddImgesAdpter(List<Map<String, Object>> datas,List<Integer>a, Context context) {
        this.datas = datas;
        this.a = a;
...
//        }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.bt_del.setVisibility(View.GONE);
        Log.e("GridViewAddImgesAdpter", "a.size():" + a.size());
        for (int i = 0; i < a.size(); i++) {

            Integer integer = a.get(i);
            Log.e("GridViewAddImgesAdpter", "integer:" + integer);
           if (integer == position){
