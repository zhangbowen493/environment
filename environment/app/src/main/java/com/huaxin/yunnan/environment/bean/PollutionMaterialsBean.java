...
/**
 * 污染源主要原辅材料信息页面bean
 * Created by zbw on 2017/10/29 13:21.
 */

public class PollutionMaterialsBean {
	@Override
	public String toString() {
		return "PollutionMaterialsBean{" +
				"data=" + data +
				", msg='" + msg + '\'' +
				", success='" + success + '\'' +
				'}';
	...
	/**
	 * data : {"pageInfo":{"pageNum":1,"pageSize":20,"totalRowNum":1},"queryData":[{"uuid":"402880495f13a695015f13a732c9004b","wrybh":"622898222","xh":123,"yfclmc":"123","ncl":123,"dw":"123","bz":"123","wuuid":"402880495f04f3a1015f05815f49019c","vc_create_user":null,"dt_create_time":null,"vc_create_mechanism":null,"vc_update_user":null,"dt_update_time":null,"vc_update_mechanism":null,"vc_status":null,"vc_workflow":null,"rownum_":1}]}
	 * msg :
	 * success : 1
	 */
	...
	public static class DataBean {
		 ...
		 * queryData : [{"uuid":"402880495f13a695015f13a732c9004b","wrybh":"622898222","xh":123,"yfclmc":"123","ncl":123,"dw":"123","bz":"123","wuuid":"402880495f04f3a1015f05815f49019c","vc_create_user":null,"dt_create_time":null,"vc_create_mechanism":null,"vc_update_user":null,"dt_update_time":null,"vc_update_mechanism":null,"vc_status":null,"vc_workflow":null,"rownum_":1}]
		 */
		...
		public static class QueryDataBean {
			...
			/**
			 * uuid : 402880495f13a695015f13a732c9004b
			 * wrybh : 622898222
			 * xh : 123
			 * yfclmc : 123
			 * ncl : 123
			...
			public String getYfclmc() {
				return yfclmc;
			}

			public void setYfclmc(String yfclmc) {
				this.yfclmc = yfclmc;
			}
